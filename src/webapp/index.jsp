...
<body>
   ...
   <b1>
	...
	<tr><td></td></tr>
	<tr>
					<td><Label>From: </b></label> <input type="text" name="from" placeholder="Source" required>

					<label>To: </b></label> <input type="text" name="To" placeholder="Destination" required></td>
</tr>
 <%
	try {
		Class.forName("org.postgresql.Driver");
		Connection con = DriverManager
				.getConnection("jdbc:postgresql://localhost/airticketapp","postgres","Poornima_5");
...
%>
				...
				<tr>
					<td><Label>Departure: </b></label> <input type="date" name="Depart" required>
