	...
	<main class="main">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				List<FlightBooking> bookingInfo = (List<FlightBooking>) request.getAttribute("bookingList");
				...
				<tr>
					...
					<%}
					if (loggedInAsUser != null) {
			     	if (LocalDate.now().isBefore(flightBooking.getBookingDate()) ){ %>
				<td><a href="CancelFlightServlet?bookingId=<%=flightBooking.getBookingId() %>&status=1" class="btn btn-danger">Cancel</a></td>	
				<%
				}
			     	  }
				%>
